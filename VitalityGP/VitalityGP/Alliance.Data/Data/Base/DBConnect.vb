...
Imports InteractiveSP.Project.Helpers
Imports System.ComponentModel
Imports DevExpress.Xpo.DB.Exceptions

Namespace InteractiveSP.Project.Data
    ...
    Public Class DbConnectData
        ...
        Private Const GenerateDemoDataKey As String = "[]GenerateDemoData"
        Private Const _ProjectName As String = "Project360Dev"
        ...
        Public Property Password() As String
            ...
            End Set
        End Property
        Public Property GenerateDemoData() As Boolean
            Get
        ...
        Public Sub LoadIniFile(ByVal iniFile As IniFile)
            ...
            GenerateDemoData = iniFile.Get(Of Boolean)(GenerateDemoDataKey)
            ...
            If Environment.MachineName = "JOHN-PC2" Then
                Server = "john-pc2\sqlexpress"
            Else
                Server = project360Server
            End If
        ...
        Public Sub SaveIniFile(ByVal iniFile As IniFile)
            ...
            iniFile.Set(Of Boolean)(GenerateDemoDataKey, GenerateDemoData)
        ...
        Public Shared Function CheckDefaults(ByVal iniFile As IniFile) As Boolean
            ...
            If (Not iniFile.ContainKey(MdbPathKey)) Then
                iniFile.Add(Of String)(MdbPathKey, _ProjectName & ".mdb")
                ret = False

            End If
            If (Not iniFile.ContainKey(SqlDbNameKey)) Then
                iniFile.Add(Of String)(SqlDbNameKey, _ProjectName)
                ret = False
            End If
            If (Not iniFile.ContainKey(DbFormatKey)) Then
                iniFile.Add(Of DbFormat)(DbFormatKey, DbFormat.Sql)
                ret = False
            End If
            If (Not iniFile.ContainKey(ServerKey)) Then
                iniFile.Add(Of String)(ServerKey, "ALLIANCE-MMOL\EXCHEQUER")
                ret = False
            End If
            If (Not iniFile.ContainKey(GenerateDemoDataKey)) Then
                iniFile.Add(Of Boolean)(GenerateDemoDataKey, True)
                ret = False
            End If
            ...
            If (Not iniFile.ContainKey(PasswordKey)) Then
                ...
                ret = False
            End If
            'Quick Fix to stop auto dialog just because ini not present
            ret = True
            Return ret
        End Function
    ...
    Public Class InitialDbCreator
        ...
        Private Sub CreateDbWorker_RunWorkerCompleted(ByVal sender As Object, ByVal e As RunWorkerCompletedEventArgs)
            If unableToCreateDb Then
                ...
                Return
            End If
            If dbConnectData.GenerateDemoData Then
